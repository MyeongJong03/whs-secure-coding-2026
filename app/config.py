...
class BaseConfig:
    ...
    CHAT_CLOCK = None
    REPORT_REASON_MIN_CHARS = 10
    REPORT_REASON_MAX_CHARS = 500
    REPORT_REASON_MAX_BYTES = 2000
    REPORT_AUTO_RESTRICTION_THRESHOLD = 3
    REPORTS_PER_PAGE = 20
    ADMIN_ITEMS_PER_PAGE = 50
    MODERATION_PAGE_MAX = 1000
    TRANSFER_MIN_AMOUNT = 1
    TRANSFER_MAX_AMOUNT = 1_000_000_000
